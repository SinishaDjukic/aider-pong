...
class Paddle:
    def __init__(self, x, y):
        ...
        self.speed = 0
        self.max_speed = 5  # Reduced for even slower movement
        self.acceleration = 0.5  # Further reduced for smoother acceleration
        self.deceleration = 0.5  # Further reduced for smoother deceleration
