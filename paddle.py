...
class Paddle:
    def __init__(self, x, y):
        ...
        self.speed = 0
        self.max_speed = 10  # Further reduced for slower movement
        self.acceleration = 1.0  # Further reduced for smoother acceleration
        self.deceleration = 1.0  # Further reduced for smoother deceleration
